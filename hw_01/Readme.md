...
В это задании не нужны интерфейсы.

Если у вас где-то есть `if room == "комната"` - то я такое сразу заерну на ревью :)

В этом задании вам не нужены интерфейсы и разбиение по пакетам, не стройте космолет.

Примерный объем решения - 350-400 строк. Больше 500 - обычно оверинжиниринг.
