...
* Тесты надо писать полноценные, те не чтобы получить покрытие, а которые реально тестируют ваш код, проверяют возвращаемый результат и тд. Они должны показывать что SearchServer работает правильно
...
* Не запихивайте всё в 1 тест, напишите несколько средних
* Обязательно используте табличное тестирование, не надо копипасты. Помните про то что поле структуры может содержать функцию
